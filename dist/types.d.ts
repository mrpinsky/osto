...
export declare type InlineBone = TextBone | HashtagBone | AtMentionBone;
...
export declare type ListBone = OrderedListBone | UnorderedListBone;
export declare type BlockBone = ParagraphBone | ListBone | TrellisImageBone;
export declare type Skeleton = BlockBone[];
